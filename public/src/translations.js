const translations = {
    'zh': {
        ...
        'changelog_subtitle': '仅展示 3 类简化事件：地域上线、地域变更、地域新增可用区（可用区变更属地域变更，非地域下线）',
    ...
    'en': {
        ...
        'changelog_subtitle': 'Shows 3 simplified event types only: Region Launch, Region Change, Region AZ Added (AZ changes count as region change, not decommission)',
    ...
    'ja': {
        ...
        'changelog_subtitle': '簡易イベント3種類のみ表示：稼働開始・地域変更・AZ追加（AZの変更も地域変更であり、サービス終了とは別）',
