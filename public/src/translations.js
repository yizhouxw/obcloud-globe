const translations = {
    'zh': {
        ...
        'view_changelog': '变更',
        'view_changelog_title': '变更记录视图',
        'view_stats': '统计',
        'view_stats_title': '统计视图',
        'filter_all_sites': '所有站点',
        'filter_all_providers': '所有云厂商',
        'filter_all_channels': '所有渠道',
        'filter_all_regions': '所有地域',
        'filters_reset': '重置筛选',
        'filter_summary_all': '当前筛选：全部',
        'filter_all_short': '全部',
        'filter_label_site': '站点',
        'filter_label_provider': '云厂商',
        'filter_label_channel': '渠道',
        'filter_label_region': '地域',
        'lang_switcher_aria': '界面语言',
        'filters_toggle': '筛选条件',
        'filters_toggle_hint': '打开或关闭筛选面板',
        'filters_panel_hint': '可多选，输入关键字可搜索；不选表示该维度不限制。',
        'filters_search': '搜索或选择…',
        'filters_done': '完成',
        ...
        'changelog_subtitle': '仅展示 4 类简化事件：地域上线、地域增加渠道、地域变更、地域新增可用区（可用区变更属地域变更，非地域下线）',
        ...
        'stats_dimension_site': '站点',
        'stats_dimension_provider': '云厂商',
        'stats_dimension_country': '国家 / 大区',
        'stats_dimension_channel': '渠道',
        'stats_summary_groups': '分组数量',
        'stats_summary_regions': 'Region 总数',
        'stats_summary_az': '可用区总数',
        'stats_chart_title': '图形展示',
        'stats_chart_regions': 'Region 数量',
        'stats_chart_az': '可用区数量',
        'stats_table_title': '列表展示',
        'stats_table_dimension': '维度',
        'stats_table_regions': 'Region 数量',
        'stats_table_az': '可用区数据量',
        'stats_table_avg_az': '平均每地域可用区',
        'stats_empty': '暂无统计数据',
        'stats_unknown': '未知',
        '地域上线': '地域上线',
        '地域下线': '地域下线',
    ...
    'en': {
        ...
        'view_changelog': 'Changes',
        'view_changelog_title': 'Change Log View',
        'view_stats': 'Stats',
        'view_stats_title': 'Stats View',
        ...
        'filter_summary_all': 'Current Filters: All',
        'filter_all_short': 'All',
        'filter_label_site': 'Site',
        'filter_label_provider': 'Provider',
        'filter_label_channel': 'Channel',
        'filter_label_region': 'Region',
        'lang_switcher_aria': 'Language',
        'filters_toggle': 'Filters',
        'filters_toggle_hint': 'Open or close filters',
        'filters_panel_hint': 'Multi-select with search. Leave empty for no restriction on that dimension.',
        'filters_search': 'Search or select…',
        'filters_done': 'Done',
        ...
        'changelog_subtitle': 'Shows 4 simplified event types: Region Launch, New Channels/Sites for Region, Region Change, Region AZ Added (AZ edits are region change, not decommission)',
        ...
        'stats_dimension_site': 'Site',
        'stats_dimension_provider': 'Cloud Provider',
        'stats_dimension_country': 'Country / Area',
        'stats_dimension_channel': 'Channel',
        'stats_summary_groups': 'Groups',
        'stats_summary_regions': 'Total Regions',
        'stats_summary_az': 'Total AZs',
        'stats_chart_title': 'Chart View',
        'stats_chart_regions': 'Regions',
        'stats_chart_az': 'AZs',
        'stats_table_title': 'Table View',
        'stats_table_dimension': 'Dimension',
        'stats_table_regions': 'Region Count',
        'stats_table_az': 'AZ Volume',
        'stats_table_avg_az': 'Avg AZ / Region',
        'stats_empty': 'No statistics available',
        'stats_unknown': 'Unknown',
        '地域上线': 'Region Launch',
        '地域下线': 'Region Offline',
        '地域增加渠道': 'Region Channels Expanded',
        '地域变更': 'Region Change',
        '地域新增可用区': 'Region AZ Added',
        ...
        '东亚-韩国中部': 'East Asia - Korea Central',
        '东南亚-马来西亚西部': 'Southeast Asia - Malaysia West',
        '欧洲-巴黎': 'Europe - Paris',
        '美国-俄勒冈': 'USA - Oregon',
    ...
    'ja': {
        ...
        'view_changelog': '変更',
        'view_changelog_title': '変更履歴ビュー',
        'view_stats': '統計',
        'view_stats_title': '統計ビュー',
        'filter_all_sites': 'すべてのサイト',
        'filter_all_providers': 'すべてのプロバイダー',
        'filter_all_channels': 'すべてのチャネル',
        'filter_all_regions': 'すべての地域',
        'filters_reset': 'フィルターをリセット',
        'filter_summary_all': '現在のフィルター：すべて',
        'filter_all_short': 'すべて',
        'filter_label_site': 'サイト',
        'filter_label_provider': 'プロバイダー',
        'filter_label_channel': 'チャネル',
        'filter_label_region': '地域',
        'lang_switcher_aria': '表示言語',
        'filters_toggle': 'フィルター',
        'filters_toggle_hint': 'フィルターパネルを開く／閉じる',
        'filters_panel_hint': '複数選択と検索に対応。未選択の次元は制限なしです。',
        'filters_search': '検索または選択…',
        'filters_done': '完了',
        ...
        'changelog_subtitle': '簡易イベント4種類：稼働開始・チャネル／サイト追加・地域変更・AZ追加（AZ調整は地域変更でありサービス終了とは別）',
        ...
        'stats_dimension_site': 'サイト',
        'stats_dimension_provider': 'クラウドプロバイダー',
        'stats_dimension_country': '国 / エリア',
        'stats_dimension_channel': 'チャネル',
        'stats_summary_groups': 'グループ数',
        'stats_summary_regions': '地域総数',
        'stats_summary_az': 'AZ総数',
        'stats_chart_title': 'グラフ表示',
        'stats_chart_regions': '地域数',
        'stats_chart_az': 'AZ数',
        'stats_table_title': '一覧表示',
        'stats_table_dimension': '軸',
        'stats_table_regions': '地域数',
        'stats_table_az': 'AZデータ量',
        'stats_table_avg_az': '地域あたり平均AZ',
        'stats_empty': '表示できる統計データがありません',
        'stats_unknown': '不明',
        '地域上线': '地域稼働開始',
        '地域下线': '地域停止',
        '地域增加渠道': 'チャネル・サイト追加',
